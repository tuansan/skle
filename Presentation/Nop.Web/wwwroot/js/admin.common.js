...
function WrapAndSaveBlockData() {
    ...
    if ($(this).hasClass("opened")) {
        ...
        saveUserPreferences(rootAppPath + 'preferences/savepreference', $(this).attr("data-hideAttribute"), true);
    } else {
        icon.addClass("fa-minus");
        icon.removeClass("fa-plus");
        saveUserPreferences(rootAppPath + 'preferences/savepreference', $(this).attr("data-hideAttribute"), false);
    }
