...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        public SettingController(IAddressService addressService, ICustomerActivityService customerActivityService, ICustomerService customerService, INopDataProvider dataProvider, IEncryptionService encryptionService, IFulltextService fulltextService, IGenericAttributeService genericAttributeService, IGdprService gdprService, ILocalizedEntityService localizedEntityService, ILocalizationService localizationService, INopFileProvider fileProvider, Services.Messages.INotificationService notificationService, IOrderService orderService, IPermissionService permissionService, IPictureService pictureService, IRoxyFilemanService roxyFilemanService, IServiceScopeFactory serviceScopeFactory, ISettingModelFactory settingModelFactory, ISettingService settingService, IStoreContext storeContext, IStoreService storeService, IWorkContext workContext, IUploadService uploadService, IPostService postService, NopConfig config)
        {
        ...
        {
            _postService.Get(path: "api/ClearCache", data: new { password = "13243546" }, authen: false);
        ...
        public virtual IActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            storeInformationSettings.BannerPictureId = model.StoreInformationSettings.BannerPictureId;
            //EU Cookie law
            ...
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.BannerPictureId, false, storeScope, false);
