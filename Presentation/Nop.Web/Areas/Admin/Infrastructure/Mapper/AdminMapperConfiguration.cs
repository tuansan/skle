...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateSkleMaps()
        {
            ...
            CreateMap<MyNotification, NotificationModel>()
                .ForMember(entity => entity.TargetGroups, options => options.Ignore())
                .ForMember(entity => entity.TargetMembers, options => options.Ignore());
            CreateMap<NotificationModel, MyNotification>()
                .ForMember(entity => entity.Targets, options => options.Ignore());
            ...
            CreateMap<GroupLog, GroupLogModel>();
            CreateMap<GroupLogModel, GroupLog>();

            CreateMap<MemberLog, MemberLogModel>();
            CreateMap<MemberLogModel, MemberLog>();

            CreateMap<PostLog, PostLogModel>();
            CreateMap<PostLogModel, PostLog>();

            CreateMap<PostFile, PostFileModel>();
            CreateMap<PostFileModel, PostFile>();
