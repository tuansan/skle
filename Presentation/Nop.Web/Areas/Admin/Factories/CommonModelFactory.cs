...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual CommonStatisticsModel PrepareCommonStatisticsModel()
        {
            ...
            {
                NumberOfOrders = _postService.GetAllPostPagedList(statusId: (int)ENStatusDeleted.Active, getOnlyTotalCount: true).TotalCount
            };
            ...
            model.NumberOfPendingReturnRequests = _groupService.GetAllGroupPagedList(getOnlyTotalCount: true).TotalCount;

            model.NumberOfLowStockProducts = _memberService.GetAllMemberPagedList(StatusId: (int)ENStatusMember.All, getOnlyTotalCount: true).TotalCount;
