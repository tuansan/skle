...
namespace Nop.Data.Mapping
{
    ...
    public partial class BaseNameCompatibility : INameCompatibility
    {
        public Dictionary<Type, string> TableNames => new Dictionary<Type, string>
        {
            ...
            { typeof(Field), "_Field" },
            { typeof(Friend), "_Friend" },
            { typeof(FriendRequest), "_FriendRequest" },
            { typeof(Group), "_Group" },
            { typeof(GroupLog), "_GroupLog" },
            { typeof(GroupMember), "_GroupMember" },
            { typeof(Member), "_Member" },
            { typeof(MemberField), "_Member_Field_Mapping" },
            { typeof(MemberBackList), "_MemberBackList" },
            { typeof(MemberLog), "_MemberLog" },
            { typeof(MyNotification), "_Notification" },
            { typeof(Post), "_Post" },
            { typeof(PostFile), "_PostFile" },
            { typeof(PostLike), "_PostLike" },
            { typeof(PostLog), "_PostLog" },
            { typeof(Province), "_Province" },
            { typeof(PostSpam), "_PostSpam" },
            { typeof(MemberMessage), "_MemberMessage" },
            { typeof(MessageToGroup), "_MessageToGroup" },
            { typeof(CountNewPostGroup), "_CountNewPostGroup" },
            { typeof(NotiMobi), "_NotiMobi" },
            { typeof(NotiMobiClick), "_NotiMobiClick" },
            { typeof(NotiNew), "_NotiNew" },
            { typeof(PostHidden), "_PostHidden" },
            { typeof(Otp), "_Otp" },
            { typeof(Report), "_Report" },
        };
