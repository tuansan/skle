...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerRegistrationService : ICustomerRegistrationService
    {
        ...
        public virtual CustomerLoginResults ValidateCustomerByPhoneNumber(string phoneNumber, string password)
        {
        ...
        public virtual bool CheckOldPassword(int customerId, string OldPassword)
        {
            return PasswordsMatch(_customerService.GetCurrentPassword(customerId), OldPassword);
        }
