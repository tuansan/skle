...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        /// </summary>
        /// <param name="PhoneNumber">PhoneNumber</param>
        public virtual bool CheckPhoneNumber(string PhoneNumber)
        {
            if (PhoneNumber == null)
                throw new ArgumentNullException(nameof(PhoneNumber));
            return _customerRepository.Table.Any(s => s.PhoneNumber == PhoneNumber);
        }
        ...
        #endregion Customer address mapping
